...
public class dada {
    ...
    private static final String appSecret = "dada85a86c579633e89";
    private static final String appKey = "9acbd2d7755719045ee2f50bcdcd477d";
    // 测试环境发单url
    private static final String ADD_ORDER_URL = "http://newopen.imdada.cn/api/order/addOrder";
